...
public class InputStreamQuarkusApplicationLoggingHandler extends LoggingHandler {
    ...
    public InputStreamQuarkusApplicationLoggingHandler(ServiceContext context, String output, InputStream from) {
        super(context);
