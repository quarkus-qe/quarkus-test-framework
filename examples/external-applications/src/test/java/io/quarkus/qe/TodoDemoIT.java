...
public class TodoDemoIT {
    ...
    @GitRepositoryQuarkusApplication(repo = REPO, branch = COMMIT, artifact = "todo-backend-1.0-SNAPSHOT-runner.jar",
            mavenArgs = DEFAULT_ARGS
                    + UBER)
    ...
    @GitRepositoryQuarkusApplication(repo = REPO, branch = COMMIT, artifact = "todo-backend-1.0-SNAPSHOT.jar",
            mavenArgs = DEFAULT_ARGS + UBER
                    + NO_SUFFIX)
